...
int Problem1()
{
	...
	IplImage* Image3_gray32, *Image4_gray32;
	...
	cvSmooth(Image3_gray32, Image3_gray32, CV_GAUSSIAN, kernel_size, kernel_size, sigma, sigma);
	...
	/*	my_cvSmooth */
  	my_cvSmooth(Image4_gray32, Image4_gray32, kernel_size, sigma);
	Image4_dst_mat = cvarrToMat(Image4_gray32);
	...
	cvSub(Image3_gray32, Image4_gray32, sub_gray32);
